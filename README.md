...
_в поддержке сказали что уже у всех он включен_
...
6. Инициализирую проект, выполнив код.
...
![alt text](https://github.com/wlasoff/netology-devops-home-terraform-3/blob/main/img/image-18.png)

![alt text](https://github.com/wlasoff/netology-devops-home-terraform-3/blob/main/img/image-19.png)

Пока так только получилось, как же это преварить в map вложенный?
