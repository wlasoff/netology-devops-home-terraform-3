...
1. В файле ansible.tf создайте inventory-файл для ansible.
Используя функцию tepmplatefile и файл-шаблон создал ansible inventory-файла из лекции.
Готовый код брал из демонстрации к лекции [**demonstration2**](https://github.com/netology-code/ter-homeworks/tree/main/03/demo).
Передалв него в качестве переменных группы виртуальных машин из задания 2.1, 2.2 и 3.2, т. е. 5 ВМ.
2. Инвентарь должен содержать 3 группы и быть динамическим, т. е. обработать как группу из 2-х ВМ, так и 999 ВМ.
3. Добавьте в инвентарь переменную  [**fqdn**](https://cloud.yandex.ru/docs/compute/concepts/network#hostname).
``` 
[webservers]
...
Создал в своем GitHub-репозитории новую ветку terraform-03. Закоммител в эту ветку свой финальный код проекта, ссылка на коммит:   

https://github.com/DmitryIll/terraform-uprav-constr/commit/bf515fb6fa26dc79ec8eb6049b50c8cd0ca16b3d
